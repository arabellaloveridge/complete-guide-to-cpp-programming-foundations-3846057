...
// Overloaded function when dist not provided
int getSpeed(double time){
    return static_cast<int>(100 / time); //assuming default dist of 100 units
}

// Overloaded function to get speed in specific format
